...
<?php
    ...
    if($page != 1){
        $prevPage = $page - 1;
        echo "<li class='first'><a href='boardSearch.php?page=1&searchKeyword={$searchKeyword}&searchOptioin={$searchOption}'>처음으로</a></li>";
        echo "<li class='prev'><a href='boardSearch.php?page={$prevPage}&searchKeyword={$searchKeyword}&searchOptioin={$searchOption}'>이전</a></li>";
    }
    ...
    for($i=$startPage; $i<=$endPage; $i++){
        ...
        echo "<li class='{$active}'><a href='boardSearch.php?page={$i}&searchKeyword={$searchKeyword}&searchOptioin={$searchOption}'>${i}</a></li>";
    }

    // 마지막으로/다음
    if($page != $boardTotalCount){
        $nextPage = $page + 1;
        echo "<li class='next'><a href='boardSearch.php?page={$nextPage}&searchKeyword={$searchKeyword}&searchOptioin={$searchOption}'>다음</a></li>";
        echo "<li class='last'><a href='boardSearch.php?page={$boardTotalCount}&searchKeyword={$searchKeyword}&searchOptioin={$searchOption}'>마지막으로</a></li>";
    }
?>
                </ul>
            </div>
