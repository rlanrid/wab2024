                    ...
                    <form action="boardModifySave.php?boardID=<?php echo $boardID;?>" name="boardWriteSave" method="post">
                        <fieldset>
                            ...
                            <!-- <div>
                                ...
                                <input type="text" id="boardTitle" name="boardTitle" class="input__style boardTitle">
                            </div>
                            <div>
                                <label for="boardContents">내용</label>
                                <textarea name="boardContents" id="boardContents" rows="20" class="input__style boardContents"></textarea>
                            </div>
                            <div class="mt50">
                                <div class="boardPass">비밀번호</div>
