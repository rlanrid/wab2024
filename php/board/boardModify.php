...
<?php 
    ...
    if($result) {
        ...
        echo "<div class='mt50'><div class='boardPass'>비밀번호</div><input type='password' id='boardPass' name='boardPass' class='input__style mb0' autocomplete='off' placeholder='글을 수정하려면 로그인 비밀번호를 입력하셔야 합니다.' required></div>";
    }
?>
