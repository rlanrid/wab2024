...
<body>
            ...
            <div class="phoneView__inner container">
                <div class="phoneView__top">
                    ...
                    <div class="phoneView__top__right">
                        ...
                        <div class="phoneView__top__bottom">
                            <a href="<?=$phoneInfo['pLink']?>" class="btn__style6">바로가기</a>
                            <button type="submit" id="LikeButton" class="btn__heart">
                                <img src="../../assets/img/heart.png" alt="찜하기">
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        // 공감버튼
        $(function(){
            let likeStatus = '<?php echo $likeStatus; ?>';
            if(likeStatus === "liked"){
                $("#LikeButton > img").attr("src", "../../assets/img/heart-already.png");
            }
